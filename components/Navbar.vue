<template>
  <nav class="fixed left-0 px-[5%] w-full z-30" >
      <div class="flex justify-between">
          <div>
              <nuxt-link to="/">
                <nuxt-picture :imgAttrs="{class:'my-1 w-[inherit] transition-all duration-200'}" class="w-14 md:w-20" :class="{'md:w-14':this.collapsed}" src='/logo.png' alt="ProShine Logo"/>
              </nuxt-link>
          </div>
